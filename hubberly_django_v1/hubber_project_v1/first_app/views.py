...
from hubber_project_v1 import settings
from . import forms
...
def spanish_home(request):
    ...
    return render(request, "home-spanish.html", {'user_form': user_form_, 'registered': registered})
...
def spanish_faqs(request):
    return render(request, "faqs-spanish.html")
